...
mlflow.autolog()        # with the help of autologer we dont need to use any logger function it will log everything on its own
...
with mlflow.start_run():
    ...
    # log the model
    mlflow.sklearn.log_model(sk_model=rf, artifact_path= 'Random-Forest-Model', registered_model_name='WineClassifier')
